...
public struct NetCodeTestGhostObjectSnapshotData : ISnapshotData<NetCodeTestGhostObjectSnapshotData>
{
    public uint tick;
    ...
    public void PredictDelta(uint tick, ref NetCodeTestGhostObjectSnapshotData baseline1, ref NetCodeTestGhostObjectSnapshotData baseline2)
    {
    ...
    public void Serialize(int networkId, ref NetCodeTestGhostObjectSnapshotData baseline, ref DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref NetCodeTestGhostObjectSnapshotData baseline, ref DataStreamReader reader,
    ...
    public void Interpolate(ref NetCodeTestGhostObjectSnapshotData target, float factor)
    {
