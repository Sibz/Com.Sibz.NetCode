...
public struct NetCodeGhostDeserializerCollection : IGhostDeserializerCollection
{
    ...
    {
        NetCodePlayModeTestGhostObjectGhostSpawnSystem curNetCodePlayModeTestGhostObjectGhostSpawnSystem =
            world.GetOrCreateSystem<NetCodePlayModeTestGhostObjectGhostSpawnSystem>();
        m_NetCodePlayModeTestGhostObjectSnapshotDataNewGhostIds =
            curNetCodePlayModeTestGhostObjectGhostSpawnSystem.NewGhostIds;
        m_NetCodePlayModeTestGhostObjectSnapshotDataNewGhosts =
            curNetCodePlayModeTestGhostObjectGhostSpawnSystem.NewGhosts;
        ...
        switch (serializer)
        {
            case 0:
                return GhostReceiveSystem<NetCodeGhostDeserializerCollection>.InvokeDeserialize(
                    m_NetCodePlayModeTestGhostObjectSnapshotDataFromEntity, entity, snapshot, baseline, baseline2,
        ...
        NetworkCompressionModel compressionModel)
    {
        switch (serializer)
        {
            case 0:
                ...
                m_NetCodePlayModeTestGhostObjectSnapshotDataNewGhosts.Add(
                    GhostReceiveSystem<NetCodeGhostDeserializerCollection>
                        .InvokeSpawn<NetCodePlayModeTestGhostObjectSnapshotData
                        >(snapshot, ref reader, compressionModel));
                break;
            default:
                throw new ArgumentException("Invalid serializer type");
        }
    ...
    private BufferFromEntity<NetCodePlayModeTestGhostObjectSnapshotData>
        m_NetCodePlayModeTestGhostObjectSnapshotDataFromEntity;

    private NativeList<int> m_NetCodePlayModeTestGhostObjectSnapshotDataNewGhostIds;

    private NativeList<NetCodePlayModeTestGhostObjectSnapshotData>
        m_NetCodePlayModeTestGhostObjectSnapshotDataNewGhosts;
}
