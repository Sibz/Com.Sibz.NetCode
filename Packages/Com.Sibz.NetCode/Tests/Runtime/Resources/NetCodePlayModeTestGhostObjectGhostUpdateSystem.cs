...
public class NetCodePlayModeTestGhostObjectGhostUpdateSystem : JobComponentSystem
{
    [BurstCompile]
...
#endif
        [ReadOnly] public ArchetypeChunkBufferType<NetCodePlayModeTestGhostObjectSnapshotData> ghostSnapshotDataType;
...
#pragma warning restore 649
    ...
    protected override void OnCreate()
    {
        ...
        {
            All = new []{
                ComponentType.ReadWrite<NetCodePlayModeTestGhostObjectSnapshotData>(),
        ...
        {
            All = new []{
                ComponentType.ReadOnly<NetCodePlayModeTestGhostObjectSnapshotData>(),
                ComponentType.ReadOnly<GhostComponent>(),
        ...
        RequireForUpdate(GetEntityQuery(ComponentType.ReadWrite<NetCodePlayModeTestGhostObjectSnapshotData>(),
            ComponentType.ReadOnly<GhostComponent>()));
    }
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        if (!m_predictedQuery.IsEmptyIgnoreFilter)
        {
            var updatePredictedJob = new UpdatePredictedJob
            {
                ...
                ghostSnapshotDataType = GetArchetypeChunkBufferType<NetCodePlayModeTestGhostObjectSnapshotData>(true),
...
public partial class NetCodePlayModeTestGhostObjectGhostSpawnSystem : DefaultGhostSpawnSystem<NetCodePlayModeTestGhostObjectSnapshotData>
{
}
