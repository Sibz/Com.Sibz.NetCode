...
public struct NetCodePlayModeTestGhostObjectSnapshotData : ISnapshotData<NetCodePlayModeTestGhostObjectSnapshotData>
{
    public uint tick;
    ...
    public void PredictDelta(uint tick, ref NetCodePlayModeTestGhostObjectSnapshotData baseline1, ref NetCodePlayModeTestGhostObjectSnapshotData baseline2)
    {
    ...
    public void Serialize(int networkId, ref NetCodePlayModeTestGhostObjectSnapshotData baseline, ref DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref NetCodePlayModeTestGhostObjectSnapshotData baseline, ref DataStreamReader reader,
    ...
    public void Interpolate(ref NetCodePlayModeTestGhostObjectSnapshotData target, float factor)
    {
