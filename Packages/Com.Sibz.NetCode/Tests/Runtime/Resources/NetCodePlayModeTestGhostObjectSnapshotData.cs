...
public struct NetCodePlayModeTestGhostObjectSnapshotData : ISnapshotData<NetCodePlayModeTestGhostObjectSnapshotData>
{
    ...
    {
        return new quaternion(RotationValueX * 0.001f, RotationValueY * 0.001f, RotationValueZ * 0.001f,
    ...
    public void Serialize(int networkId, ref NetCodePlayModeTestGhostObjectSnapshotData baseline,
        ref DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref NetCodePlayModeTestGhostObjectSnapshotData baseline,
